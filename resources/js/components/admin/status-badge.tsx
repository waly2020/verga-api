...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
    ...
    // Publicité
    validée:     { label: 'Validée',     className: 'bg-blue-100 text-blue-800 border-blue-200 hover:bg-blue-100' },
    refusée:     { label: 'Refusée',     className: 'bg-red-100 text-red-800 border-red-200 hover:bg-red-100' },
    publiée:     { label: 'Publiée',     className: 'bg-green-100 text-green-800 border-green-200 hover:bg-green-100' },
    expirée:     { label: 'Expirée',     className: 'bg-gray-100 text-gray-600 border-gray-200 hover:bg-gray-100' },
    retirée:     { label: 'Retirée',     className: 'bg-orange-100 text-orange-800 border-orange-200 hover:bg-orange-100' },
    non_payé:    { label: 'Non payé',    className: 'bg-yellow-100 text-yellow-800 border-yellow-200 hover:bg-yellow-100' },
    payé:        { label: 'Payé',        className: 'bg-green-100 text-green-800 border-green-200 hover:bg-green-100' },
